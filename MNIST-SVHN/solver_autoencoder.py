...
class Solver(object):
    ...
    def train(self):
        ...
        fixed_mnist_noise = get_noise(3, 'noise', (32, 32)).type(dtype).detach()
        # fixed_mnist_noise = torch.randn((1, 1, 32, 32)).type(dtype).detach()
        ...
        for step in range(self.train_iters + 1):
            ...
            self.reset_grad()
            mnist = get_noise(3, 'noise', (32, 32)).type(dtype).detach()

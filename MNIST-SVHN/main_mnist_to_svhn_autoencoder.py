...
from solver_autoencoder_M_S import Solver
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./results/models_autoencoder_M_S')
    parser.add_argument('--sample_path', type=str, default='./results/samples_autoencoder_M_S')

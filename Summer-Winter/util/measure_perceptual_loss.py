######################################################################
#  code was taken from here: https://pytorch.org/tutorials/advanced/neural_style_tutorial.html
######################################################################
import torch
...
class ContentLoss(nn.Module):
    ...
    def __init__(self, target, ):
        ...
        # not a variable. Otherwise the forward method of the criterationion
        # will throw an error.
...
def run_style_transfer(content_img, style_img, input_img, cnn=cnn_model,
